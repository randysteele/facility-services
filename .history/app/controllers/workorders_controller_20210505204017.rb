class WorkordersController < ApplicationController
  ...
  #  @workorder = Workorder.new
    @workorder = @client.workorders.build
  end
  ...
  #  @workorder = Workorder.new(workorder_params)
     @workorder = @client.workorders.build(workorder_params)

    respond_to do |format|
      if @workorder.save
        format.html { redirect_to client_workorders_path(@client), notice: "Workorder was successfully created." }
  ...
  def update
    respond_to do |format|
      if @workorder.update(workorder_params)
        format.html { redirect_to client_workorder_path(@client), notice: "Workorder was successfully updated." }
  ...
  def destroy
    @workorder.destroy
    respond_to do |format|
      format.html { redirect_to client.workorders_path(@client), notice: "Workorder was successfully destroyed." }
  ...
  private
    ...
    def set_workorder
     # @workorder = Workorder.find(params[:id])
       @workorder = @client.workorders.find(params[:id])
    end
